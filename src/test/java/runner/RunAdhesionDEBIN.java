...
//@SelectFile("src/test/resources/features/adhesionDEBIN.feature")
...
@ConfigurationParameter(key = FILTER_TAGS_PROPERTY_NAME, value = "@AdhesionDEBIN")
// Ejecutar solo escenarios marcados
public class RunAdhesionDEBIN {
}
